...
Scripts are executed directly from the GitHub repository using raw URLs:

```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/[org]/[repo]/[commit]/scripts/[script-name].sh)"
```

**Benefits of this approach:**

- ✅ No need to upload scripts to the server
- ✅ Always uses the exact version from the workflow commit
- ✅ No temporary files left on the server
- ✅ Cleaner and more secure execution
- ✅ Scripts are sourced directly from version control
